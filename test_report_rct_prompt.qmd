---
title: " Testing prompt (rct prompt) "
...
-- **Answer (GPT)**: The study is a randomized trial of a prenatal and infancy home visitation program delivered by nurses to high-risk primiparous mothers, clearly an intervention occurring before children reach high school. The trial reports impacts on outcomes related to caregiving behavior and child maltreatment, which are social-emotional/behavioral outcomes assessed in early childhood. Although the abstract only describes outcomes through the first two years of life and does not mention adult follow-up, the screening rules state that records should not be excluded merely because adult outcomes are not reported in the current abstract, as long as it is plausible that the trial could have later follow-ups. Given that this is a randomized early childhood intervention with relevant early social-emotional outcomes, it could plausibly have produced or be linked to adult follow-up reports. Therefore, the record should be included for further review.
...
-- **Answer (GPT)**: The study is a randomized controlled trial of a nurse home-visitation program delivered prenatally and through the child’s first two years of life, clearly before high school entry. It reports child cognitive and social-emotional outcomes near the end of the intervention (tests of children’s mental development and mothers’ reports of children’s behavioral problems). It also reports adult outcomes for the mothers (educational achievement, labor-force participation, and welfare use) during the follow-up period, when mothers are adults. Even though child participants are not followed into adulthood in this particular report, the trial is pre–high school, includes relevant child cognitive/social-emotional outcomes at intervention end, and includes adult outcomes for participating mothers. Moreover, this trial is known to have longer-term follow-ups in other publications. In line with the instruction to favor inclusion when eligibility is plausible or information is incomplete, this record should be included for further review.
...
-- **Answer (GPT)**: The study is a randomized controlled trial (Multimodal Treatment Study of Children with ADHD) with participants aged 7–9.9 years, clearly before high school, and involves a 14‑month intervention, satisfying the pre–high school intervention criterion. It reports quantitative posttreatment outcomes on parenting behavior and child behaviors, which fall under social-emotional/behavioral domains, meeting the requirement for cognitive or social-emotional outcomes at or near the end of treatment. The MTA trial is known to have long-term follow-ups of participants into later adolescence and adulthood; thus this record is plausibly part of a trial that later measured adult outcomes, even though this specific paper focuses on immediate posttreatment results. According to the instructions, such companion or primary trial reports from RCTs that may have adult follow-ups should be included. Therefore, the record should be classified as INCLUDE for further review.
...
-- **Answer (GPT)**: The record describes a randomized trial in which public schools were randomly assigned to the Iowa Strengthening Families Program delivered in 6th grade, i.e., before high school. The outcomes reported are reductions in exposure to opportunities for illicit substance use across adolescence and illicit substance use in 12th grade, which counts as at or beyond the end of high school and therefore as adulthood per the inclusion criteria. The intervention is a universal family-based preventive program targeting substance use and related behaviors, which are social-emotional/behavioral outcomes. Although this specific abstract focuses on adolescent and 12th-grade outcomes, the underlying ISFP trial plausibly included quantitative social-emotional or behavioral measures at or near the end of the intervention (e.g., substance use, exposure opportunities, or related behavioral scales) even if these are not detailed here. The study is clearly randomized, the intervention occurred before high school, and there are outcomes at the end of high school (treated as adult outcomes). Given the instructions to favor inclusion when in doubt and the likelihood that end-of-intervention social-emotional outcomes were measured in the trial or companion reports, this record should be included for further review.
...
-- **Answer (GPT)**: The study is a cluster-randomized controlled trial of a classroom-based intervention implemented in preschool (Head Start) classrooms, clearly before high school. It measures social-emotional outcomes (internalizing and externalizing behavior problems) at the end of the intervention. The abstract does not mention any adult follow-up, but per the screening rules, we should not exclude based solely on the absence of adult outcomes in this particular report; it could be part of a larger trial that later followed participants into adulthood or might have related companion publications. Randomization is clear and the population and outcomes meet the pre-high-school and cognitive/social-emotional criteria, with the possibility (though not stated) of later adult outcomes. Therefore it should be retained as potentially eligible for further review.
...
-- **Answer (GPT)**: The study is a multicomponent, cluster-randomized efficacy trial conducted in Head Start preschool classrooms with low-income children (pre-high school). It clearly reports cognitive (preacademic skills: vocabulary, letter-naming, math) and social-emotional/self-regulation outcomes (attention/impulse control, executive function) from fall to spring of the preschool year. Although this article focuses on short-term outcomes and does not mention any adult follow-up, the trial could plausibly have later adult outcome reports or linked administrative follow-ups. Given the screening rule to prioritize recall and include when adult follow-up is unclear, this record should be included for further review as a potentially eligible randomized controlled trial of a childhood intervention with relevant end-of-intervention cognitive and social-emotional outcomes that may have adult follow-up elsewhere.
...
-- **Answer (GPT)**: This article conducts a de novo, quantitative reanalysis of three well-known randomized early childhood intervention trials: the Abecedarian Project, Perry Preschool, and the Early Training Project. All three are established randomized controlled trials with interventions occurring in early childhood, well before high school entry. These trials are known to have measured cognitive and social-emotional outcomes at or near the end of the intervention, and they have documented long-term (adult) follow-up outcomes. The current paper examines treatment effect heterogeneity by gender and applies multiple-inference corrections to short- and long-term outcomes, explicitly discussing both short- and long-term benefits. Even though the abstract does not restate all details about original posttest measures or adult outcomes, it clearly refers to long-term benefits and is a secondary analysis of eligible RCTs. Therefore, it plausibly reports or relies on adult outcomes from randomized trials with earlier cognitive/social-emotional measures, meeting all three inclusion criteria. The record should be included for further review.
...
-- **Answer (GPT)**: The record reports a harmonized primary data analysis of multiple early childhood enrichment and home-visiting programs that are described as interventions for disadvantaged children and their caregivers. These are iconic early childhood programs that plausibly began and ended before participants entered high school. The abstract explicitly states that the programs permanently boost cognitive and non-cognitive skills, indicating that the original trials measured cognitive and social-emotional outcomes at or near the end of the intervention. The paper reports long-run life-cycle data when participants are middle-aged and when their children are in their twenties, clearly satisfying the requirement for adult outcomes and even intergenerational outcomes. Although this is a cross-program synthesis rather than a single-trial report, it conducts original quantitative analyses of data from randomized early childhood interventions with long-run follow-up, which fits the inclusion rule for secondary analyses of eligible trials. Randomization is strongly implied by the reference to iconic early childhood programs known to be randomized trials. Hence, the study is potentially eligible and should be INCLUDED for further review.
...
-- **Answer (GPT)**: The study analyzes impacts of the Abecedarian early childhood intervention, which is a well-known randomized controlled trial. The intervention took place in early childhood (before school entry) and the abstract discusses cognitive outcomes (IQ subtests, general cognitive ability g) measured repeatedly from age 5 through age 21. Thus: (1) the intervention clearly occurred before high school, (2) cognitive skills were measured at and after the end of the intervention, and (3) outcomes were assessed in adulthood (age 21). The design is randomized, and the article reports quantitative treatment effects. Therefore, the record meets all inclusion criteria and should be included.
...
-- **Answer (GPT)**: This record reports a 19-year follow-up of the Elmira Nurse-Family Partnership, described explicitly as a randomized trial in which nurse home visitation was provided prenatally and through the child’s second birthday. Thus, the intervention clearly occurred and ended well before high school entry. The outcomes at age 19 include educational achievement, welfare use, reproductive behaviors, and criminal involvement, which are adult outcomes. Although this particular abstract does not describe the end-of-intervention child cognitive or social-emotional outcomes, it is well known that the original Elmira Nurse-Family Partnership trial measured child developmental and behavioral outcomes, and per the screening rules, adult follow-up reports from such trials should be included even if the end-of-intervention outcomes are not restated. The design is randomized, the intervention timing is pre–high school, and adult outcomes are measured; the study therefore plausibly meets all inclusion criteria and should be included for further review.
...
-- **Answer (GPT)**: The study is a randomized trial of nurse home visitation beginning in pregnancy and continuing through the child’s second year, with follow-up assessments when children are 25–50 months old. While it involves an early-life intervention and reports relevant child cognitive/behavioral and caregiving outcomes, there is no indication of any outcomes measured in adulthood (age 18+ or post–high school). All reported follow-up is clearly limited to early childhood (3rd and 4th years of life). Therefore, the record clearly fails the adulthood-outcomes criterion and should be excluded.
...
-- **Answer (GPT)**: Include. The study clearly reports a randomized controlled trial in which preschool children in special education were randomly assigned to different types of preschool classrooms (direct instruction vs mediated learning), which is an intervention delivered and completed before high school entry. Earlier follow-ups evidently measured academic achievement and related cognitive outcomes at or near the end of the preschool intervention and during subsequent schooling. This article reports outcomes at 19 years of age, which is an adult follow-up, including academic achievement and special education status. The design is explicitly randomized, the intervention is clearly pre–high school, cognitive/academic outcomes were measured, and adult outcomes at age 19 are reported. Therefore, it meets all inclusion criteria as a potential eligible trial or follow-up report.
...
-- **Answer (GPT)**: The Infant Health and Development Program is clearly a randomized early childhood intervention (center-based care in years 2–3 of life), so it meets the pre–high school intervention criterion and almost certainly measured cognitive outcomes at the end of intervention. However, this specific record only reports follow-up effects at age 8 years, which is clearly before age 18 and before completion of high school. There is no indication of any outcomes measured in adulthood (18+ or post–high school). Because the eligibility criteria require that the trial report, or the record concern, outcomes measured in adulthood, and this record’s outcomes are exclusively at age 8, it clearly fails criterion 3. Therefore, this record should be excluded.
...
-- **Answer (GPT)**: The study is a multisite randomized trial (Infant Health and Development Program) of an early preschool educational intervention delivered over the first 3 years of life to low birth weight premature infants, clearly before high school entry. The abstract describes an 18-year follow-up assessing multiple adult outcomes including cognitive (PPVT-III, Woodcock-Johnson reading and math, Wechsler IQ) and behavioral/mental health and risk behaviors (behavior problem indices, YRBSS). Although this specific article focuses on outcomes at age 18, the original trial is well known to have measured cognitive and behavioral development during and at the end of the early childhood intervention period. Thus, the record pertains to a randomized controlled trial with an intervention before high school, cognitive and social-emotional outcomes at intervention end (from the original trial), and quantitative adult outcomes at age 18. It therefore meets all inclusion criteria and should be included.
...
-- **Answer (GPT)**: This record reports on Project STAR, a randomized controlled trial in which students and teachers were randomly assigned to classrooms from kindergarten to third grade—well before high school entry—thus meeting criterion 1. The original trial collected test scores and noncognitive measures at the end of classes in grades K–3, which are cognitive and social-emotional outcomes, satisfying criterion 2. The article examines long-term impacts by linking the experimental data to administrative records and reports outcomes in adulthood, including earnings at age 27, college attendance, home ownership, and retirement savings, fulfilling criterion 3. Random assignment is explicit, the intervention is clearly pre–high school, and adult outcomes are clearly measured. Therefore, the record should be included for further review.
...
-- **Answer (GPT)**: The record analyzes Project STAR, a well-known randomized controlled trial (students randomly assigned to small vs. regular classes in early primary school). The intervention occurs in primary school, thus clearly before high school. Prior publications of Project STAR document cognitive/academic test-score outcomes at the end of the intervention, and this abstract explicitly notes "test-score effects at the time of the experiment," which are cognitive outcomes. This paper focuses on adult outcomes—college enrollment, college choice, and degree completion—measured in postsecondary years, satisfying the adulthood outcome criterion. The design is randomized, pre-high-school, includes cognitive outcomes at intervention end, and measures adult outcomes, so it meets all inclusion criteria. Therefore, it should be included for further review.
...
-- **Answer (GPT)**: The study is based on Project STAR, a 4-year multicenter randomized controlled trial of reduced class sizes in Tennessee, with random assignment of children to small versus regular classes in the early school years. The intervention occurred before high school entry and ended in early grades. The abstract explicitly reports improved measures of cognition and academic performance at the end of the intervention, satisfying the requirement for cognitive or social-emotional outcomes at or near intervention end. The present article examines mortality through age 29 years, which is clearly an adult outcome. The design is randomized, the intervention is pre–high school, relevant cognitive outcomes were measured at intervention end, and adult outcomes (mortality) are analyzed. Therefore, it clearly meets all inclusion criteria and should be included.
...
-- **Answer (GPT)**: This record clearly concerns Project STAR, a well-known multi-center randomized controlled trial in Tennessee that randomly assigned students in kindergarten through third grade (K-3) to small vs. regular class sizes. The intervention was delivered before high school and ended by the end of third grade, satisfying the pre–high school intervention criterion. The abstract explicitly notes that Project STAR improved cognition, indicating that cognitive outcomes were measured and impacted at or near the end of the intervention. The study links trial participants to Social Security Administration data on earnings, employment, and disability from ages 18–28, which unambiguously satisfies the requirement for outcomes measured in adulthood. The design is clearly randomized, and the outcomes are quantitative. Therefore, this study meets all inclusion criteria and should be classified as INCLUDE.
...
-- **Answer (GPT)**: The study describes a randomized field trial of the Good Behavior Game implemented in first and second grade classrooms in elementary schools, clearly before high school. It is a universal classroom-based behavior management intervention targeting aggressive and disruptive behavior, which are social-emotional outcomes. The article reports impacts on service use for problems with emotions, behavior, or drugs or alcohol in young adulthood, which are adult outcomes. Random assignment, pre–high school intervention timing, social-emotional focus, and adult follow-up outcomes are all clearly present, so the record should be included.
...
-- **Answer (GPT)**: The study describes the Good Behavior Game, a universal classroom behavior management program implemented in first- and second-grade classrooms. This clearly satisfies the criterion that the intervention occurred and ended before high school. The program targets classroom behavior and socialization to the student role, aiming to reduce aggressive and disruptive behaviors—these are social-emotional outcomes that would have been measured at or near the end of the intervention in the original trial, even though this particular abstract focuses on later follow-up. The design is randomized: schools were matched and randomly assigned to conditions, and within intervention schools, classrooms and teachers were randomly assigned to intervention or control, meeting the randomized controlled trial requirement. The article reports outcomes at ages 19–21, which are clearly adult outcomes (drug and alcohol abuse/dependence disorders, smoking, antisocial personality disorder, and other behavioral/psychiatric/social outcomes). Therefore, the record clearly meets all three inclusion criteria and should be included.
...
-- **Answer (GPT)**: The study is a randomized clinical trial of prenatal and infancy nurse home visitation (an intervention clearly delivered before high school and ending in toddlerhood). The trial is well known to have measured child developmental outcomes earlier in life, and the abstract notes child developmental screening in the control condition, making it plausible that cognitive or social-emotional outcomes were assessed at or near the end of the intervention even though they are not reported in this particular follow-up paper. This article reports follow-up outcomes at child ages 12 and 18 years, with age 18 meeting the adulthood criterion. Outcomes at follow-up concern obesity and hypertension, which are eligible adult outcomes. Random assignment is explicit, and there is no indication that the trial lacked cognitive or social-emotional outcomes—information is simply not provided here. Under the high-recall rule, the record should be included as it plausibly belongs to an eligible randomized trial with pre–high school intervention, likely cognitive or social-emotional outcomes at intervention end, and adult outcomes at age 18.
...
-- **Answer (GPT)**: The record reports on three randomized controlled trials of intensive prenatal and infant/toddler nurse home visiting for low-income mothers and their children, with follow-up over about two decades. The intervention clearly starts prenatally and continues through infancy/toddlerhood, well before high school entry, so Criterion 1 is satisfied. The current abstract focuses on long-term maternal and child mortality outcomes using the National Death Index, which occur in adulthood or at least long after the intervention; thus Criterion 3 (adult outcomes) is satisfied. Although this particular abstract does not mention cognitive or social-emotional outcomes at intervention end, these nurse home visiting RCTs (e.g., Nurse-Family Partnership trials in Elmira, Memphis, and Denver) are well-known to have collected child development and behavioral outcomes, and it is plausible that cognitive or social-emotional skills were assessed at or near the end of the intervention in at least some trial reports. Per the instructions, if it is unclear from this record whether such outcomes were measured, the record should be included. The design is explicitly randomized (3 RCTs). Therefore, this record could plausibly be a follow-up/companion publication from an eligible trial, and should be classified as INCLUDE for further review.
...
-- **Answer (GPT)**: This study is a randomized clinical trial of the Nurse-Family Partnership, in which 742 pregnant, low-income women were randomly assigned to nurse home visiting during pregnancy and infancy versus a control condition. The intervention clearly occurs prenatally and in infancy, ending long before high school entry, satisfying the timing criterion. The current article reports outcomes when the offspring are 18 years old, including cognition (nonverbal intelligence, receptive language, math achievement), academic achievement, and a range of behavioral health outcomes (internalizing problems, substance use, arrests, convictions, etc.), which fulfills the adulthood follow-up criterion. Although this abstract does not explicitly describe end-of-intervention child outcomes, earlier NFP randomized trials are known to have measured child cognitive and behavioral outcomes at or near the end of the intervention, and per the instructions, adult follow-up reports should not be excluded for not restating those earlier outcomes. Random assignment is clearly stated, and the design is a randomized controlled trial. Therefore, this record should be included as it plausibly belongs to an eligible RCT with pre–high school intervention and adult outcomes, and likely includes or is linked to end-of-intervention cognitive or social-emotional measures.
...
-- **Answer (GPT)**: The study is a randomized clinical trial of a prenatal and infant/toddler nurse home-visiting intervention delivered from pregnancy through child age 2 years, clearly before high school. It reports adult outcomes: maternal all-cause mortality over 21 years and child preventable-cause mortality up to age 20, which qualifies as adulthood. Although this follow-up article focuses on mortality and does not describe end-of-intervention child cognitive or social-emotional outcomes, prior publications from this well-known trial plausibly include such measures, and the instructions specify that adult follow-up reports should not be excluded merely because they do not restate earlier cognitive or social-emotional outcomes. Random assignment is explicit. There is no clear evidence that cognitive or social-emotional outcomes were not measured at intervention end. Therefore, given the need for high recall and plausible eligibility, the record should be included for further review.
...
-- **Answer (GPT)**: The study is a randomized controlled trial (the NIMH MTA study) of childhood ADHD treatments, clearly conducted in children (ages 10–13 at this 3-year follow-up). Although it measures relevant social-emotional and academic outcomes (ADHD and ODD symptoms, social skills, reading scores, impairment, and diagnostic status), all reported follow-up outcomes in this record are assessed at approximately age 10–13, which is well before adulthood and before completion of high school. The abstract provides no indication of any adult (18+) or post–high school outcomes, and the focus is explicitly on the 36-month follow-up shortly after treatment ended. Thus, based on the information given, the record clearly fails the adulthood outcome criterion and should be excluded.
...
-- **Answer (GPT)**: The study is a randomized controlled trial with children aged 7–9.9 years and examines treatment effects on parent-reported homework problems, including a 10‑month follow-up. Although it clearly involves a randomized childhood intervention and measures a social-emotional/behavioral outcome (homework problems) near the end of the intervention and follow-up, there is no indication of any outcomes measured in adulthood (age 18+ or post–high school). All reported follow-up is within months after treatment in childhood. Because the inclusion criteria require that the trial have at least one follow-up measuring outcomes in adulthood, and this record clearly only covers childhood outcomes, it should be excluded.
...
-- **Answer (GPT)**: The study is a follow-up of the Multimodal Treatment Study of ADHD (MTA), which began as a 14‑month randomized clinical trial of behavioral and pharmacological treatments for children aged 7–10, clearly before high school. The trial therefore meets the pre–high school intervention criterion. The original MTA randomized trial is well known to have measured cognitive and social-emotional/behavioral outcomes at the end of the intervention period (e.g., ADHD symptoms, functioning), so it plausibly included eligible cognitive or social-emotional posttest measures, even though this follow-up abstract focuses on later outcomes. This particular record reports outcomes in early adulthood at about 25 years of age (symptom severity and adult height), clearly satisfying the adulthood outcome criterion. The design is explicitly randomized at baseline. Thus the record is a long-term adult follow-up of an eligible randomized childhood intervention trial and should be included.
...
-- **Answer (GPT)**: Classify as INCLUDE. The study evaluates long-term effects of the New Beginnings Program, a preventive parenting intervention delivered to divorced mothers when their children were ages 9–12, which is clearly before high school entry. The New Beginnings Program is a well-known randomized controlled trial, though randomization is not restated in this abstract; under the screening rules, unclear or unstated design should still be treated as potentially randomized. The current article focuses on outcomes in young adulthood (G2 parenting attitudes), which clearly satisfies the adulthood follow-up criterion. It is highly plausible, and known from the broader literature, that the original trial measured child social-emotional and behavioral outcomes at or near the end of the intervention (e.g., parenting behavior, child adjustment), and nothing in the abstract rules this out. Under the high-recall rules, any plausible randomized preventive parenting intervention delivered before high school with adult follow-up should be included. Therefore, this record should be retained as a potentially eligible RCT follow-up report.
...
-- **Answer (GPT)**: The record describes a randomized, experimental trial of the New Beginnings parenting-skills preventive intervention targeting children aged 9–12 at baseline, clearly before high school for at least part of the sample and prior to adulthood. The intervention is designed to affect children’s post-divorce adjustment, fulfilling the pre–high school intervention criterion. The publication reports a 6-year follow-up, at which point participants would be approximately 15–18 years old; some may have reached age 18 or completed high school, and exact ages/educational stages at follow-up are not fully specified. Under the inclusion rules, uncertainty about exact age or grade at follow-up warrants inclusion. The trial is explicitly randomized, satisfying the design requirement. Although this particular abstract focuses on educational goals and job aspirations, it also reports program-induced changes in mother–child relationship quality and youth externalizing problems, internalizing problems, self-esteem, and academic competence, which are clearly social-emotional and cognitive/academic outcomes. While these mediators are measured at the 6-year follow-up rather than explicitly at intervention end, the larger trial plausibly included cognitive or social-emotional outcomes at or near the end of the intervention, and absence of explicit mention is not grounds for exclusion. Because the study is a randomized preventive intervention delivered before high school, includes psychosocial and academic variables, and reports longer-term educational and occupational outcomes around the transition to adulthood with some uncertainty about exact ages, it could plausibly meet all eligibility criteria. Therefore, it should be classified as INCLUDE for further review.
...
-- **Answer (GPT)**: The study is based on a randomized, experimental trial of a parenting-focused preventive intervention targeting children aged 9–12, which is before high school for most educational systems. The intervention is designed to improve children’s postdivorce adjustment via changes in mother-child relationship quality and discipline, indicating a parenting/relationship-focused intervention delivered during late childhood. The study examines short-term (6 months) and long-term (6 years) changes in children’s coping processes, including coping efficacy and active coping. These are clearly social-emotional outcomes. The long-term follow-up at 6 years after baseline implies participants are approximately 15–18 years old; some may have reached adulthood (18+), but exact ages at follow-up and schooling stage are not fully specified. According to the rules, uncertainty about exact age or educational stage at follow-up warrants inclusion. The trial is randomized, assesses social-emotional outcomes at or near intervention end (6-month follow-up), and includes a long-term follow-up that may extend into adulthood. Therefore, the record is plausibly an eligible randomized controlled trial with pre–high school intervention and long-term outcomes that may include adults, so it should be included for further review.
...
-- **Answer (GPT)**: The study is a 15-year follow-up of the randomized New Beginnings Program preventive intervention for divorced families with children aged 9–12, clearly before high school. It is explicitly described as a randomized trial. The follow-up assesses mental health and substance use outcomes in young adulthood, satisfying the adulthood outcome criterion. Although the abstract does not state the end-of-intervention outcomes, this is a well-known trial that assessed children’s mental health and behavior (social-emotional outcomes) at earlier follow-ups, and it is highly plausible that social-emotional outcomes were measured at or near intervention end. Even if that were unclear, the instructions say to include when such information is missing or unclear. Therefore, the record should be included for further review.
...
-- **Answer (GPT)**: The study is a 15-year longitudinal follow-up of a randomized controlled trial of the New Beginnings parenting-focused preventive intervention delivered to divorced families when children were 9-12 years old, clearly before high school. The abstract indicates random assignment to an 11-session program vs. a literature control condition. Assessments occurred at pretest, posttest, and 3- and 6-month follow-ups (near intervention end), during adolescence, and again at 6 and 15 years. The trial examined intervention effects on behavior problems and competencies during adolescence, which are social-emotional and cognitive/academic outcomes at or following the intervention period. The follow-up at 15 years assesses outcomes in emerging adulthood (work, academic, peer, and romantic competence), i.e., participants are clearly 18 or older. Thus, the record meets all three inclusion criteria: (1) pre-high-school intervention, (2) cognitive/social-emotional outcomes during or near the end of the intervention/adolescence, and (3) adult outcomes. It is a randomized controlled trial with relevant adult follow-up, so it should be included.
...
-- **Answer (GPT)**: The record clearly describes a randomized controlled trial of two universal preventive interventions delivered in first grade (early elementary school), which is before high school entry. The interventions targeted aggressive behavior and academic achievement, and the study reports academic outcomes such as standardized achievement test scores, special education service use, high school graduation, and postsecondary education. These include cognitive outcomes at or near the end of the intervention (academic achievement) and longer-term educational outcomes through age 19, which qualifies as adulthood per the inclusion criteria. The abstract explicitly notes that the findings come from a randomized controlled trial and reports follow-up outcomes in high school and at age 19. Therefore, this record meets all three key criteria and should be included.
...
-- **Answer (GPT)**: The study evaluates two universal first-grade preventive interventions (classroom-centered and family-school partnership), clearly occurring before high school. It examines immediate effects on poor achievement (cognitive/academic), concentration problems (executive/attention), aggression, and shy behaviors (social-emotional), which are explicit cognitive and social-emotional proximal outcomes at the end of the intervention period (first and second grades). The design appears to involve assigned interventions at the classroom/school level, and randomization is plausible though not explicitly stated in the abstract; per instructions, such uncertainty requires inclusion. Although the abstract reports only proximal impacts and does not mention adult outcomes, this record could be a primary trial report for an intervention that may later have adult follow-ups or companion publications with adult outcomes. Given that all three main criteria could plausibly be met and no criterion is clearly violated, the record should be included at title/abstract screening for further review.
...
-- **Answer (GPT)**: The study analyzes data from an elementary school-based universal preventive intervention trial, indicating an intervention delivered before high school. The design is described as a preventive intervention trial, plausibly randomized; per instructions, when randomization is unclear, the record should be included. Although this particular paper focuses on the interaction between a polygenic score and the intervention on timing of first marijuana use (from sixth grade to age 18), the underlying elementary school trial likely included social-emotional or behavioral outcomes (e.g., substance use, behavior problems) at or near the end of the intervention, which qualifies as social-emotional. Adult outcomes are plausibly present because the survival analysis window extends through age 18, which meets the adulthood criterion, and genetic data were collected in emerging adulthood. The record also appears to be a secondary/companion analysis of an existing trial, which is eligible. There is no clear evidence that any of the three key criteria are not met. Therefore, the record should be included for further review.
...
-- **Answer (GPT)**: The record describes an empirical test of Terrie Moffitt's developmental taxonomy of delinquency using general growth mixture modeling. It examines naturally occurring trajectories of delinquent behavior (life-course-persistent, adolescence-limited, and abstainers) and correlates such as hyperactivity, concentration problems, peer deviance, and social bonds. There is no indication of any randomized intervention, no mention of an intervention being delivered in childhood or before high school, and no trial design. The study appears to be purely observational/analytic, modeling developmental trajectories rather than evaluating the impact of a program. Therefore, it clearly fails the randomized controlled trial criterion and should be excluded.
...
-- **Answer (GPT)**: The study is a randomized controlled trial in which 678 urban first-graders were randomly assigned to one of two elementary school-based preventive interventions or a control classroom condition. The intervention clearly occurs in early elementary school (first grade), therefore before high school entry, satisfying Criterion 1. The article reports follow-up annually until one year beyond anticipated high school graduation (mean age ~18 years), which qualifies as adult or near-adult outcomes according to the inclusion rules (Criterion 3). The reported outcomes (risk of being offered tobacco and transition to smoking) are behavioral and fall under social-emotional/behavioral domains; even though it is not explicitly stated that cognitive or social-emotional skills were measured at the end of the intervention, the interventions are early school-based prevention programs and it is plausible that earlier publications from this trial measured such outcomes at or near intervention end. Per the instructions, when such information is unclear, the record should be included to preserve high recall. The trial is clearly randomized, with quantitative analysis of outcomes. Therefore, this record should be classified as INCLUDE for further review.
...
-- **Answer (GPT)**: The study is a randomized controlled trial of a family-focused (parent-training) prevention intervention targeting adolescents’ substance use and delinquency, which are eligible social-emotional/behavioral outcomes. However, the abstract clearly indicates that all outcomes are measured during adolescence. The analysis uses five waves of data on "rural adolescents" and focuses on growth in adolescent substance use and delinquency over time, with no indication that follow-up extends into adulthood (age 18+ or post–high school). There is no suggestion of adult or post–secondary outcomes, and the outcomes are explicitly framed as occurring in adolescence. Therefore, the study clearly fails the adulthood follow-up criterion and should be excluded.
...
-- **Answer (GPT)**: The study is clearly based on a randomized controlled trial: 33 rural schools were randomly assigned to conditions. The intervention (Preparing for the Drug Free Years) targeted families of 6th graders, meaning it was implemented before high school entry and ended during early adolescence. The abstract indicates that mediators were measured at posttest (age 12), including prosocial skills, which are social-emotional outcomes. The primary outcome analyzed in this paper is alcohol abuse disorder at age 22, which is an adult outcome. Thus, the study satisfies all three key criteria: (1) intervention before high school, (2) cognitive/social-emotional outcomes at intervention end (prosocial skills), and (3) outcomes measured in adulthood (age 22). Therefore, this record should be included for further review.
...
-- **Answer (GPT)**: The study is a randomized trial of a family-focused prevention curriculum (Preparing for the Drug-Free Years) delivered to parents of sixth graders, so the intervention clearly occurs before high school and includes outcomes related to adolescent alcohol use and relevant social-emotional/family risk factors. However, all reported follow-ups are from early to mid adolescence, up to 3.5 years after baseline, and there is no indication of any outcomes measured when participants were 18 or older or beyond high school/upper-secondary education. Thus, it clearly fails the adulthood outcome criterion and should be excluded.
...
-- **Answer (GPT)**: The interventions (ISFP, PDFY, SFP 10-14, Life Skills Training) clearly began in sixth and seventh grade, so they meet the pre-high-school intervention criterion and are randomized school-based trials. However, all reported follow-up outcomes are measured during participants’ late high school years (4.5–6.5 years after baseline, when baseline was in early middle school). The abstract explicitly states that the study examines methamphetamine use "during their late high school years," and there is no indication of any follow-up extending beyond high school or age 18. The only outcomes discussed are adolescent methamphetamine use during high school, not adult outcomes. Therefore, the record clearly fails the adulthood follow-up criterion and should be excluded.
...
-- **Answer (GPT)**: The study reports on long-term effects of universal preventive interventions that were conducted during middle school (6th and 7th grade) in public schools, with schools randomly assigned to different intervention or control conditions, satisfying the randomized controlled trial criterion. The interventions clearly occurred before high school entry and ended in middle school, meeting the pre–high school intervention timing requirement. The current report focuses on prescription drug misuse outcomes at ages 17–21, which include measures at age 21 (adulthood), thus fulfilling the adult outcome criterion. Although this abstract does not explicitly describe cognitive or social-emotional outcomes measured at the end of the intervention, the interventions (Iowa Strengthening Families Program, Preparing for the Drug Free Years, Life Skills Training, and SFP 10-14) are established preventive programs targeting youth substance use and related behavioral outcomes, which fall under social-emotional domains. Earlier reports from these randomized trials plausibly include quantitative social-emotional or behavioral outcomes at or near intervention end, and the instructions specify that adult follow-up reports should not be excluded merely because they do not restate those outcomes. Therefore, the record could plausibly be part of an eligible randomized trial and should be included for further review.
...
-- **Answer (GPT)**: This study reports on universal family-focused interventions delivered in middle school (6th grade), which is clearly before high school entry. The interventions (ISFP and PDFY) were randomly assigned at the school/family level, satisfying the randomized design criterion. The article focuses on young adult substance use outcomes (drunkenness, alcohol-related problems, cigarettes, illicit drugs, and polysubstance use) measured in young adulthood, which meets the requirement for adult outcomes. Although the abstract emphasizes young adult substance use and mediation via delayed adolescent substance initiation, the broader trial of these interventions is well known to have measured adolescent behavioral and social-emotional outcomes (such as substance initiation and related behaviors) during and after the intervention period, which qualify as social-emotional outcomes. Even if the exact timing of those adolescent outcomes relative to the end of the intervention were not explicit here, the instructions specify to include when such details are unclear. Therefore, this record is plausibly a follow-up report from an eligible randomized trial and should be INCLUDED for further review.
...
-- **Answer (GPT)**: The record describes two longitudinal randomized studies in which rural schools were randomly assigned to universal, family-focused and school-based preventive interventions versus minimal-contact control conditions. The interventions are school- and family-focused universal preventive programs delivered in rural schools, thus clearly pre-high-school or at least school-age and plausibly before or around early secondary education, with the exact school level and ages not specified; per instructions, this ambiguity favors inclusion. The studies examine "proximal outcomes" of competency-training preventive interventions, which are highly likely to be cognitive or social-emotional/behavioral outcomes (e.g., competence, behavior, adjustment, or related constructs), although the abstract does not specify exact measures; again, the ambiguity supports inclusion. The article focuses on implementation quality and proximal outcomes and does not mention adult follow-up, but it reports on randomized universal preventive interventions that could plausibly have later adult follow-ups in other publications. Given the instruction to prioritize very high recall, to include companion or primary reports from trials that may later have adult outcomes, and not to exclude based on lack of explicit adult outcomes in this particular abstract, this record should be retained as potentially eligible. Therefore, it is classified as INCLUDE (coded as 1).
...
-- **Answer (GPT)**: The study is a randomized controlled trial: 22 rural schools were randomly assigned to either the Iowa Strengthening Families Program (ISFP) or a minimal-contact control group. The intervention is delivered to families of 6th graders, which is clearly before high school entry, and the intervention effects on proximal outcomes are measured in 6th grade. Among these proximal outcomes is student substance-related risk, which qualifies as a social-emotional/behavioral outcome measured near the end of the intervention. The study examines long-term outcomes on school engagement in 8th grade and academic success in 12th grade (high school seniors). While the exact ages are not provided, 12th grade/high school senior status plausibly corresponds to age 18 or close to it. According to the inclusion rules, in cases where exact age is unclear but adulthood (18+) is plausible, the record should be included. Therefore, the study plausibly meets all three criteria and should be classified as INCLUDE for further review.
...
-- **Answer (GPT)**: The study clearly involves randomized controlled trials of universal preventive interventions delivered during middle school, i.e., before high school entry. The abstract focuses on long-term outcomes of prescription drug misuse assessed in late adolescence and young adulthood (ages 21, 22, and 25, and 12th grade), which qualifies as adult or near-adult outcomes under the inclusion criteria. While the abstract does not explicitly describe the end-of-intervention outcomes, these programs (SFP 10-14, Life Skills Training, and related school-based interventions) are well-known social-emotional and behavioral interventions, and it is highly plausible that the original trials measured social-emotional or behavioral outcomes (e.g., substance use, conduct, other problem behaviors) at or near the end of the intervention. Per the screening rules, if it is unclear whether cognitive or social-emotional outcomes were measured at intervention end, the record should be included. The design is explicitly randomized, the intervention was delivered before high school, and adult follow-up outcomes are reported, so the record should be included for further review.
...
-- **Answer (GPT)**: The study evaluates the Iowa Strengthening Families Program, a universal family-focused preventive intervention delivered in sixth grade (young adolescence, clearly before high school). Participants and their families from 22 school districts were randomly assigned to experimental conditions, indicating a randomized controlled trial. Internalizing symptoms (a social-emotional outcome) were measured repeatedly from grades 6–12, thus at and near the end of the intervention period. The study also reports outcomes in young adulthood at age 21, which satisfies the adulthood follow-up criterion. The design is randomized, the intervention occurs before high school, relevant cognitive/social-emotional outcomes are measured during adolescence, and adult outcomes are reported, so the record should be included.
...
-- **Answer (GPT)**: The record clearly describes an observational study examining self-regulation as a resilience factor against peer deviance effects on antisocial behavior from age 17 to 19. There is no indication of any intervention, let alone a randomized controlled trial, nor any mention of childhood or pre–high school intervention, or end-of-intervention cognitive/social-emotional outcomes. Outcomes are observational changes in antisocial behavior in late adolescence, not adult follow-up from a childhood RCT. Therefore, it clearly fails the randomized trial and intervention criteria and should be excluded.
...
-- **Answer (GPT)**: The study is based on a randomized trial (the Family Check-Up) delivered in early adolescence, with participants recruited in 6th grade from middle schools, so the intervention clearly occurs before high school entry. Outcomes relevant to social-emotional development and mental health are measured during adolescence (parent–youth relationship quality, depressive symptoms, eating attitudes, and health-related behaviors), satisfying the requirement for cognitive or social-emotional outcomes at or near the end of the intervention. Adult outcomes are assessed at age 22 in the form of obesity status, which is an eligible adult outcome. The design is explicitly randomized, and there is no indication that follow-up is restricted to pre-18 outcomes. Therefore, this record plausibly reports (or is linked to) an eligible randomized controlled trial with pre–high school intervention, adolescent social-emotional outcomes, and adult outcomes, so it should be included for further review.
...
-- **Answer (GPT)**: Include. The study is an experimental longitudinal field trial with random assignment to the Family Check-Up (FCU), delivered in middle school (before high school). It follows youth from ages 12 to 18–19 and examines antisocial behavior, family conflict, deviant peer association, and parental monitoring—social-emotional outcomes—across adolescence. Outcomes at ages 18–19 are assessed, which meets the adulthood criterion (age ≥18). Although the abstract does not explicitly state that social-emotional outcomes were measured exactly at intervention end, it clearly measures such outcomes during and after the intervention period, and adult outcomes (age 18–19) are reported. Therefore, this record plausibly reports or is linked to an eligible randomized trial and should be included at title/abstract screening.
...
-- **Answer (GPT)**: The record describes an observational longitudinal study examining associations between coercive parent-adolescent interactions (assessed via videotaped observations at ages 16–17) and subsequent substance use and antisocial behaviors through early adulthood. There is no intervention, no random assignment, and no indication of a childhood or pre–high school program whose effects are being evaluated. The study is purely correlational/predictive and not a randomized controlled trial. Therefore, it clearly fails the randomized trial criterion and should be excluded.
...
-- **Answer (GPT)**: The study is a randomized controlled trial involving 2nd- and 3rd-grade children receiving intensive reading remediation, satisfying the criteria for an RCT with a pre–high school intervention and cognitive outcomes (reading, spelling) measured at posttest. However, the only follow-up mentioned is a 1-year follow-up, which clearly occurs while participants are still in elementary school and well before age 18 or completion of high school. There is no indication of any adult or post–high school outcomes. Because the available information clearly shows that all reported outcomes were measured in childhood and not in adulthood, the record fails the adulthood outcome criterion and should be excluded.
...
-- **Answer (GPT)**: The study examines “intensive reading remediation in grade 2 or 3” with follow-up “a decade later.” The intervention clearly occurs before high school. The primary focus of the intervention is reading remediation, implying cognitive/academic outcomes (reading and spelling measures) were measured at or near the end of the intervention, and the abstract notes statistical tests on reading and spelling outcomes. The follow-up a decade later includes outcomes such as high school completion, which indicates assessment around the end of or beyond high school (approximately age 17–18 or later), satisfying the adulthood outcome criterion. Although randomization is not explicitly stated in the truncated abstract, the design details are unclear rather than clearly nonrandom, so per the instructions the record should be retained. Therefore this record is plausibly a randomized controlled trial of a pre–high school intervention with cognitive outcomes at intervention end and educational outcomes in (near) adulthood, and should be included for further review.
...
-- **Answer (GPT)**: The study is a randomized trial of a combined family and school-based preventive intervention delivered via schools, likely before or during early secondary education, which could meet the pre–high school intervention criterion. However, the reported outcomes are substance initiation, regular alcohol use, and weekly drunkenness assessed 2.5 years after baseline in an in-school assessment. There is no indication that participants were adults (18+ or beyond high school) at follow-up; rather, they are still in school. The abstract does not suggest any adult follow-up or outcomes measured after completion of high school. Therefore, the study clearly fails the adulthood outcome criterion and should be excluded.
...
-- **Answer (GPT)**: The study evaluates a school-based preventive intervention delivered to middle school students, so it satisfies the pre–high school intervention criterion. It measures social-emotional/behavioral outcomes (substance initiation, refusal intentions, expectancies), so criterion 2 could be satisfied. However, all reported outcomes are assessed during middle school, with three waves of data from middle school students. There is no indication of any follow-up into adulthood (age 18+ or post–high school). Because it is clear that the follow-up is limited to adolescence before high school completion, the study fails the adulthood outcomes criterion and should be excluded.
...
-- **Answer (GPT)**: The study is a cluster randomized controlled trial of two universal preventive interventions (LifeSkills Training and Strengthening Families Program 10–14) delivered in seventh grade, which is prior to high school entry in the U.S. context. The interventions are school-based and family-focused substance misuse prevention programs targeting early adolescents, clearly fitting the criterion that the intervention occurs and ends before high school. The paper reports young adult (age 22) depression symptoms as outcomes, which satisfies the requirement for adult outcomes. Although the abstract does not explicitly describe cognitive or social-emotional outcomes at the end of the intervention, such programs typically assess social-emotional or behavioral outcomes (e.g., substance use, relationship/behavior problems, skills) at or near intervention end, and the instructions specify to INCLUDE when this information is unclear or not fully stated. Randomization is explicitly stated. Therefore, the record plausibly concerns an eligible randomized trial with pre–high school intervention and adult outcomes, and should be classified as INCLUDE for further review.
...
-- **Answer (GPT)**: The study evaluates the PROSPER community–university partnership using a community-level randomized control design with rural communities and middle school students (data collected from fall of 6th grade through spring of 9th grade). Outcomes are youth, parent, and family protective factors and skills (e.g., association with antisocial peers, child management, parent–child affective quality) during middle school and early high school years. There is no indication of any outcomes measured in adulthood (age 18+ or post–high school). Thus, the study clearly fails criterion 3 (adult follow-up outcomes). Although the design is randomized and involves social-emotional/behavioral outcomes, the absence of adult outcomes renders it ineligible for inclusion.
...
-- **Answer (GPT)**: The study is a randomized controlled trial of community–university partnerships implementing family-focused and school-based preventive interventions in 6th and 7th grades. Outcomes are substance use measures (lifetime, past-month, past-year use of various substances) assessed up to 4.5 years after baseline. There is no indication that cognitive or social-emotional skills were measured at or near the end of the intervention; the focus is exclusively on substance use behaviors. Moreover, the longest follow-up (4.5 years after baseline for 6th–7th graders) likely corresponds to mid-adolescence (around ages 16–17) and does not clearly include any outcomes at age 18 or beyond, nor after completion of high school. Thus, the record clearly fails the adult-outcomes criterion, and also does not clearly meet the requirement for cognitive or social-emotional outcomes at intervention end. It should therefore be excluded.
...
-- **Answer (GPT)**: The study is based on a randomized design in which 28 public school districts were randomly assigned to the PROSPER delivery system or usual programming. The interventions (a family-focused intervention in 6th grade and a school-based intervention in 7th grade) clearly occurred before high school entry and ended before high school. The paper reports outcomes at age 19 (post–high school), which meets the adulthood follow-up criterion. Although this particular abstract focuses on emerging adult substance misuse and risk behaviors, the underlying PROSPER trials are universal preventive interventions aimed at young adolescents and plausibly included earlier posttest assessments of social-emotional or behavioral outcomes (e.g., substance use, antisocial behavior) at or near the end of the intervention. Since this is an adult follow-up of a randomized, pre–high school intervention with likely social-emotional outcomes at intervention end, it should be included for further review.
...
-- **Answer (GPT)**: The study evaluates the PROSPER universal prevention delivery system implemented in middle schools, with randomization at the school-district level, clearly indicating a randomized controlled trial. The intervention is delivered in middle schools, thus occurring before high school entry, satisfying the timing criterion. The outcomes assessed in this report are substance misuse and conduct problem behaviors in emerging adulthood (ages 19–25), which are valid adult outcomes. Although this particular abstract focuses on adult follow-up, it explicitly references “more robust adolescent stage findings,” which strongly implies that earlier adolescent (i.e., near end-of-intervention) outcomes were measured, and these are social-emotional/behavioral outcomes (substance misuse and conduct problems). Even if those end-of-intervention results are reported elsewhere, the trial clearly falls within the scope of a randomized early intervention with later adult follow-up on social-emotional outcomes. Therefore, it plausibly meets all three eligibility criteria and should be included for further review.
...
-- **Answer (GPT)**: The record concerns the Chicago School Readiness Project, which is a well-known randomized early childhood (preschool) intervention. The title and abstract indicate that the study examines impacts in late adolescence on academic achievement, executive functioning, emotional regulation, and behavioral problems. This clearly implies: (1) The intervention occurred before high school (in preschool), (2) the original trial measured cognitive and social-emotional outcomes at or near the end of the intervention (school readiness, achievement, behavior are standard CSRP outcomes, even if not restated here), and (3) this report analyzes outcomes in late adolescence (likely age 18+ or near the end of secondary schooling). The design is based on a randomized trial, and the paper provides quantitative estimates of adult/late-adolescent outcomes. Therefore, it plausibly meets all inclusion criteria and should be included for further review.
...
-- **Answer (GPT)**: The study is a lottery-based randomized evaluation of charter middle schools examining impacts on student achievement (test scores) during middle school. Although it is a randomized study with cognitive outcomes, it does not involve any follow-up into adulthood (age 18+ or post–high school). All reported outcomes are during middle school, clearly before high school completion and adulthood. Therefore, it fails the adulthood outcome criterion and should be excluded.
...
-- **Answer (GPT)**: The study tracks students who applied to KIPP middle schools via admissions lotteries in 5th or 6th grade, which implies a randomized admission process and an intervention taking place in middle school, i.e., before high school entry. The report focuses on long-term outcomes of college enrollment and early college persistence, which are clearly adult outcomes. Although the abstract does not explicitly state that cognitive or social-emotional outcomes were measured at the end of the intervention, KIPP middle-school RCT/lottery studies typically assess academic achievement (test scores) and related school performance outcomes at or near the end of middle school. Because the design is plausibly randomized, the intervention clearly occurs before high school, and the follow-up outcomes are in adulthood, and because end-of-intervention cognitive/achievement outcomes could reasonably have been measured even though not mentioned here, the record should be retained at title/abstract screening. Therefore, it is classified as INCLUDE.
...
-- **Answer (GPT)**: The study is a randomized experimental evaluation of KIPP middle schools using admissions lotteries, so it meets the randomized trial criterion. The intervention is delivered in middle school, which is before high school entry, so criterion 1 could be eligible. The measured outcomes include academic achievement (reading, math, science, social studies, higher-order thinking) and student behaviors, which are cognitive and social-emotional outcomes at the end of intervention or during middle school, thus meeting criterion 2. However, the abstract clearly indicates that the outcomes examined are limited to middle school achievement and behaviors; there is no indication of any follow-up into adulthood (age 18+ or post–high school). Therefore, criterion 3 is clearly not met, and the record should be excluded.
...
-- **Answer (GPT)**: The record describes an observational longitudinal study of alcohol use, internalizing symptoms, peer deviance, and emotional disengagement among emerging adults aged 20–22. There is no indication of any randomized controlled trial, no childhood or pre–high school intervention, and no mention of intervention endline outcomes or adult follow-up from a childhood trial. All data are collected in adulthood with no experimental manipulation. Therefore, the study clearly fails the trial/intervention criterion and should be excluded.
...
-- **Answer (GPT)**: The study is a randomized controlled trial of the Family Check-Up (FCU), a school-based, family-centered intervention delivered to middle school students (6th–8th grades), so criterion 1 (intervention before high school) is satisfied. It reports quantitative impacts on self-regulation and behavior problems, so criterion 2 (cognitive or social-emotional outcomes at intervention end) is also clearly satisfied. However, all reported outcomes are followed only from 6th through 8th grade, i.e., during middle school, and the abstract provides no indication of any outcomes measured in adulthood (age 18+ or post–high school). It is therefore clear that the follow-up does not extend into adulthood and criterion 3 is not met. Consequently, this record should be excluded.
...
-- **Answer (GPT)**: The study is a randomized trial of the Family Check-Up intervention delivered in public middle schools (6th grade) with follow-up through 9th grade. Thus, the intervention clearly occurs before high school, and it measures social-emotional outcomes (depressive symptoms, family conflict) during adolescence. However, all reported outcomes are measured from 6th through 9th grade, i.e., before age 18 and before or at the early stages of high school, with no indication of any follow-up into adulthood or beyond grade 12. Because the available information clearly shows there are no adult outcomes, the study fails the adulthood follow-up criterion and should be excluded.
...
-- **Answer (GPT)**: The study is a randomized controlled trial of the Parents Who Care universal prevention program delivered to adolescents in eighth grade. Outcomes reported are at 24-month follow-up and include attitudes toward drug use, delinquent and violent behavior, and initiation of substance use and sexual activity. While these are social-emotional/behavioral outcomes, all measured outcomes are clearly during adolescence (approximately 10th grade) and there is no indication of any adult follow-up (age 18+ or post–high school). Therefore, the study clearly fails the adulthood outcome criterion and should be excluded.
...
-- **Answer (GPT)**: The record is a conceptual or narrative discussion of adolescent and young adult problem behaviors and related risk and protective factors. It does not describe a randomized controlled trial, any specific intervention implemented and evaluated, or quantitative outcomes. The focus is on adolescence and young adulthood, not on an intervention delivered and completed before high school entry. There is no indication of cognitive or social-emotional outcomes measured at the end of an intervention, nor of any adult follow-up outcomes from a randomized trial. Therefore, it clearly fails the core eligibility criteria for inclusion and should be excluded.
...
-- **Answer (GPT)**: The study evaluates the Strong African American Families program, a randomized family skills training intervention delivered to 11-year-old fifth-grade students and their caregivers (i.e., clearly before high school). It reports impacts on social-emotional/behavioral outcomes such as conduct problems, low self-control, deviance-prone peer affiliations, and parenting and youth protective processes, satisfying the requirement for cognitive or social-emotional outcomes at or near intervention end. However, all outcomes are measured between pretest and a long-term follow-up 29 months later, which corresponds to early adolescence (approximately ages 11–13/14) and clearly before age 18 and before completion of high school. The abstract provides no indication of any outcomes measured in adulthood or after completion of upper-secondary education. Because it is clear that all reported follow-up outcomes occur prior to adulthood, the record fails the adulthood-outcomes criterion and should be excluded.
...
-- **Answer (GPT)**: The study is a randomized controlled trial involving 11-year-old children (before high school) and their mothers, assigned to a 7-week family-oriented psychosocial intervention versus control. The intervention clearly occurs before high school entry. The abstract reports adult outcomes at age 19 (inflammatory cytokines), satisfying the adulthood outcome criterion. The abstract does not specify what outcomes were measured at the end of the intervention, but the intervention targets parenting, family relationships, and youth competencies, making it plausible that social-emotional or related psychosocial measures were collected at or near intervention end, possibly reported in another publication. Because title-and-abstract screening requires high recall and information on end-of-intervention outcomes is unclear but plausibly present, the record should be included for further review.
